...
class InertiaSpringRenderer {
     ...
     *
     * @param serializer       PageObjectSerializer implementation used to serialize the {@link io.gitlab.inertia4j.spi.PageObject}.
    ...
    /**
     * Constructs an InertiaSpringRenderer using the default {@link io.gitlab.inertia4j.core.SimpleTemplateRenderer}.
     *
     * @param serializer       PageObjectSerializer implementation used to serialize the {@link io.gitlab.inertia4j.spi.PageObject}.
     * @param versionProvider provider for the current Inertia asset version
     * @param templatePath path to the HTML template to be rendered
     * @throws io.gitlab.inertia4j.core.TemplateRenderingException if the template file cannot be read.
     */
    public InertiaSpringRenderer(
        PageObjectSerializer serializer,
        VersionProvider versionProvider,
